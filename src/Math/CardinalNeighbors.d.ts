 ...
 * - etc.
 */
export declare const MooreNeighborhood2D: Readonly<[number, number][]>;
/**
 ...
 */
export declare const MooreNeighborhood3D: Readonly<[number, number, number][]>;
/**
 * A read-only array of 3D coordinates (x, y, z) representing
 ...
 * Each tuple `[dx, dy, dz]` is an offset from the center cell.
 */
export declare const CardinalNeighbors3D: Readonly<[number, number, number][]>;
/**
* A read-only array of 2D coordinates (x, y) representing
...
* Each tuple `[dx, dy]` is an offset from the center cell.
*/
export declare const CardinalNeighbors2D: Readonly<[number, number][]>;
