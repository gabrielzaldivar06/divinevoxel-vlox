 ...
 */
export interface ArchivedSectionPaletteJSONData extends BaseArchivedSectionPaletteData<JSONBinaryBufferData> {
}
/**
 * Interface representing the buffer data for a section.
 */
export interface ArchivedSectionBuffersJSONData extends BaseArchivedSectionBuffers<JSONBinaryBufferData> {
}
/**
