...
import { ArchivedLightSegments, BaseArchivedDataBase, BaseArchivedSectorData } from "./Archive.types";
import { ArchivedSectionData, ArchivedSectorDuplicteData } from "./ArchivedSector.types";
export interface ArchiveAreaPalettesData {
    voxelStateSchemas: Record<string, VoxelBinaryStateSchemaNode[]>;
    voxelSchemas: Record<string, {
