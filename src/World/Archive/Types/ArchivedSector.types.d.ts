...
import { ArchivedLightSegments, BaseArchivedDataBase, BaseArchivedSectionBuffers, BaseArchivedSectionData, BaseArchivedSectionPaletteData, BaseArchivedSectorData } from "./Archive.types";
/**
 * Interface for an archived sector.
 */
export interface ArchivedSectorData extends BaseArchivedDataBase, BaseArchivedSectorData {
 ...
 */
export interface ArchivedSectionPaletteData extends BaseArchivedSectionPaletteData<BinaryBufferData> {
}
/**
 * Interface representing the buffer data for a section.
 */
export interface ArchivedSectionBuffers extends BaseArchivedSectionBuffers<BinaryBufferData> {
}
