import { VoxelArchivePaletteData, VoxelArchiPaveletteExportedJSONData, ArchivedVoxelPaletteDataKey } from "../../Voxels/Archive/VoxelArchive.types";
import { BinaryBufferData, JSONBinaryBufferData } from "../../Util/BinaryBuffer/BinaryBuffer.types";
...
export interface ArchivedVoxelTemplatePaletteData extends VoxelArchivePaletteData {
    level?: BinaryBufferData;
    secondary?: BinaryBufferData;
}
...
export interface ArchivedVoxelTemplatePaletteDataExportedJSONData extends VoxelArchiPaveletteExportedJSONData {
...
export interface ArchivedVoxelTemplateExportedJSONData extends BaseVoxelTemplateData {
